    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        void signUpNewUser()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl(full_name,dob,contact_no,email,district,city,zipcode,full_address,member_id,password,account_status) " +
                    "values(@full_name,@dob,@contact_no,@email,@district,@city,@zipcode,@full_address,@member_id,@password,@account_status)", con);
